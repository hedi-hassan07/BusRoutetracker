...
const PRESET_NEIGHBORHOODS = [
  ...
  { name: 'ڕانیە، شەقامی پێشەوا، نزیک قەڵاتی نوێ', lat: 36.251, lng: 44.8769, area: 'پێشەوا' },
  { name: 'ڕانیە، گەڕەکی ڕزگاری، شەقامی سەرەکی بازاڕ', lat: 36.2505, lng: 44.8942, area: 'ڕزگاری' },
